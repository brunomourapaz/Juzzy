...
public class IntervalT2MF_Intersection extends IntervalT2MF_Prototype
{
    ...
    public IntervalT2MF_Intersection(IntervalT2MF_Interface a, IntervalT2MF_Interface b,  String typeIntersection)
    {
        ...
        if(intersectionExists)
        {
            ...
            this.uMF = new T1MF_Intersection("uMF of Intersection of ("+a.getName()+","+b.getName()+")", a.getUMF(),b.getUMF(),  typeIntersection);
            this.lMF = new T1MF_Intersection("lMF of Intersection of ("+a.getName()+","+b.getName()+")", a.getLMF(),b.getLMF(),  typeIntersection);            
